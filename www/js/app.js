...
let isFloatingTimerDismissed = localStorage.getItem('liwanag_floating_timer_dismissed') === 'true';
...
auth.onAuthStateChanged((user) => {
  if (user) {
    ...
    if (typeof SecureAuth !== 'undefined' && !SecureAuth.SessionManager.isMFAVerified()) {
      console.log('[App] Firebase user active but MFA not verified yet — holding dashboard.');
      hideLoading();
